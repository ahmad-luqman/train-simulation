...
Phase 3 is now implemented in [the dispatch notes](PHASE_3_DISPATCH.md), superseding the shared-loop reservation and platform limitations above. Its scope was: explicit blocks and platform reservations, physically smoother movement and bottleneck diagnostics, followed by Phase 4's operating economy. The outstanding Phase 0/1 browser and performance baseline should be completed before expanding those systems.
